...
export const feesApi = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    ...
    // GET /api/fee-payments/student/:studentId/receipts - Fee page par "Payment History" list yahin se aati hai
    getPaymentHistory: builder.query({
      query: (studentId) => `/fee-payments/student/${studentId}/receipts`,
      providesTags: [{ type: "Fee", id: "RECEIPTS" }],
    }),
    // GET /api/fee-payments/receipt/:paymentId - ek specific receipt ki poori detail
